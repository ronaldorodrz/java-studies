...
Repositório dedicado ao armazenamento de anotações, exercícios práticos e pequenos projetos desenvolvidos durante a minha jornada de aprendizado na linguagem **Java**.

## Materiais de Referência

Durante o aprendizado, utilizo os seguintes recursos e cursos de apoio:
